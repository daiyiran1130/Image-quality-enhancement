#!/usr/bin/env python3
"""
Draw fig1.2.2.many.py — CI-box figure for MULTI degradation types.
...
Layout   : 2x2 groupplot, x-axis = 16 multi degradation types
...
OUT_PATHS = [
    r"D:\work\figure_table\figure2\classify_with_degradation\Draw fig1.2.2.many.tex",
    r"C:\Users\冰糖雪梨\PycharmProjects\PythonProject\Draw fig1.2.2.many.tex",
]
...
# LaTeX labels: replace + with \,+\, for nicer spacing, rotate applied in style
SCOPE_LABELS = [s.replace('+', '{+}') for s in SCOPE_ORDER]
...
ln(
    ...
    r'        vertical sep=3.2cm,',   # extra vertical gap for rotated x-labels
    r'    },',
    r'    width=40.0cm, height=7.0cm,',
    '    xtick={' + xtick_str + '},',
