...
\useasboundingbox (-3.0cm,2.0cm) rectangle (56.3cm,-39.9cm);
...
\node[anchor=north west, font=\footnotesize, text=gray!80!black] at (0cm,-37.95cm) {
  $^{***}$\,$p<0.001$ vs.\ Ours: all comparisons reach this significance level and are not individually annotated.
};
